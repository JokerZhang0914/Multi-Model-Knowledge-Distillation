...
def get_args():
    ...
    # parser.add_argument("--encoder_ckpt", default="/home/zhaokaizhang/code/Multi-Model-Knowledge-Distillation/checkpoints/finetune/FT_20260127-150903_seed127_split0.75_lr1e-05_batchsize64/finetuned_encoder_best.pth", type=str)
    # parser.add_argument("--student_ckpt", default="/home/zhaokaizhang/code/Multi-Model-Knowledge-Distillation/checkpoints/finetune/FT_20260127-150903_seed127_split0.75_lr1e-05_batchsize64/finetuned_student_best.pth", type=str)
    parser.add_argument("--encoder_ckpt", default="/home/zhaokaizhang/code/test_code/runs/cam_res/2026-0311-1445_layercam/checkpoint/best_resnet_encoder.pth", type=str)
    parser.add_argument("--student_ckpt", default="/home/zhaokaizhang/code/test_code/runs/cam_res/2026-0311-1445_layercam/checkpoint/best_resnet_student.pth", type=str)
