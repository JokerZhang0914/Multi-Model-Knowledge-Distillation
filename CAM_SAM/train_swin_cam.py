...
def get_args():
    ...
    parser.add_argument("--ckpt", default='/mnt/nas1/disk03/zhaokaizhang/code/test_code/runs/cam_swin/2026-0311-1809_layercam/checkpoint/best_swin.pth', type=str, help="Swin 预训练权重路径")
